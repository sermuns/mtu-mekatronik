...
\paddedfbox{
      ...
      binär (eller digital) funktion, det vill säga att lampan är antingen tänd eller släckt.
      Med funktionen \texttt{analogWrite} kan man istället styra ljusstyrkan på
      en lampa med hjälp av \texttt{PWM}. (Läs på om detta i \href{https://mek.samake.se/arduino/kompendium}{Arduino-kompendiet.})
}
