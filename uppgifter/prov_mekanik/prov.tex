...
\begin{center}
        \paddedfbox{
                Svara på frågorna som ställs i uppgifterna. Du får inte ha formelblad. Du får inte heller använda miniräknare, men därför finns några förenklingar som du ska använda:
                \vspace{0.5em}
                \begin{itemize}
                        \item Använd $g$ = \SI{10}{\meter/\second\squared} för enklare beräkning.
                        \item Om du tycker att beräkningen är för svår, \textbf{avrunda inte}, utan skriv ner hur du skulle göra om du hade en miniräknare.
                \end{itemize}
        }
\end{center}
