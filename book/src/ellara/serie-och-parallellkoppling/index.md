...
Kretsar i verkligheten är ofta lite mer komplicerade än att alla komponenter är kopplade i serie eller att alla kopmonenter är kopplade parallellt. I kretsen nedan syns det att $R_1$ och $R_2$ är kopplade parallellt med varandra. Den parallellkopplingen är dock kopplad i serie med $R_3$ och spänningskällan.

<!-- todo BILD: en spänningskälla, R1 och R2 parallellt, R3 i serie.  -->
...
<!-- todo bild enligt upgbeskrivning -->
...
BILD
<!-- todo BILD där R12 och R3 är i serie -->
...
Kirchoffs spänningslag säger att alla spänningar i en krets efter ett helt varv ska vara noll. Detta ger
