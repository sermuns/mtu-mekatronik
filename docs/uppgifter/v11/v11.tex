...
\paddedfbox{
      ...
      \href{https://mek.samake.se/mikrokontroller/komp.pdf}{Arduino-kompendiet.}
}
...
ljusstyrkan
till sitt max, och sedan minskar ljusstyrkan till svagt igen.
Detta repeteras om-och-om igen.

\textbf{Tips:} Om du uppdaterar ljusstyrkan för fort så kanske du inte hinner se någon förändring. Testa att använda \texttt{delay} för att sakta ner uppdateringen.
